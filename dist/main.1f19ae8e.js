...
var aa = document.getElementById("scope"); // dom.after(aa, div);
// dom.before(aa,div);
// dom.append(aa,div);
// dom.wrap(aa,div)
// dom.remove(aa)
...
var sa = dom.find("#one")[0];
var sa1 = dom.find('#two')[0];
var cc = dom.find("#empty")[0];
console.log(sa);
...
console.log(cc);
dom.each(dom.children(cc), function (n) {
  dom.style(n, 'border', '1px solid #ccc');
});
console.log(dom.index(sa1));
var box = dom.find('#test>.red')[0];
console.log(box);
